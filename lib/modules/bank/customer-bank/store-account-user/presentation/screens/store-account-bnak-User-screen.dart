...
import '../controller/store-customer-bank-account/store-bank_account-Custom-binding.dart';
import '../controller/store-customer-bank-account/store-bank_account-Custom-controller.dart';


class StoreAccountUserScreen extends GetView<StoreAccountUserController> {
  const StoreAccountUserScreen({Key? key}) : super(key: key);

  static const name = '/storeAccountUser';
  static final page = GetPage(
      name: name,
      page: () => const StoreAccountUserScreen(),
      binding: StoreAccountUserBinding()
  );
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AppSubmitButton(
                      onTap:(){ controller.storeAccountUserBank(
