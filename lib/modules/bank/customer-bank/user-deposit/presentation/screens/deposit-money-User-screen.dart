...
import '../controller/deposit-User-bank-account/deposit-User-binding.dart';
import '../controller/deposit-User-bank-account/deposit-User-controller.dart';


class DepositUserScreen extends GetView<DepositUserController> {
  const DepositUserScreen({Key? key}) : super(key: key);

  static const name = '/depositUserScreen';
  static final page = GetPage(
      name: name,
      page: () => const DepositUserScreen(),
      binding: DepositUserBinding()
  );
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AppSubmitButton(
                      onTap:(){ controller.depositUserBank();}  //controller.storeAccountUserBank(,'hhh','','',1),
                    ),
                    SizedBox(
                      height: 5.w,
                    ),
