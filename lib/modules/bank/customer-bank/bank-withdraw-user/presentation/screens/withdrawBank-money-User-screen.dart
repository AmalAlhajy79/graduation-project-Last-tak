...
import '../controller/withdrawBank-User-bank-account/withdrawBank-User-binding.dart';
import '../controller/withdrawBank-User-bank-account/withdrawBank-User-controller.dart';


class WithdrawBankUserScreen extends GetView<WithdrawBankUserController> {
  const WithdrawBankUserScreen({Key? key}) : super(key: key);

  static const name = '/withdrawBankUserScreen';
  static final page = GetPage(
      name: name,
      page: () => const WithdrawBankUserScreen(),
      binding: WithdrawBankUserBinding()
  );
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AppSubmitButton(
                      onTap:(){ controller.withdrawBankUserBank();}  //controller.storeAccountUserBank(,'hhh','','',1),
                    ),
                    SizedBox(
                      height: 5.w,
                    ),
