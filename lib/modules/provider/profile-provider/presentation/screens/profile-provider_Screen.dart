...
class ProviderProfile extends GetView<ShowProfileProviderController> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppScaffold(
      ...
      Padding(
          padding: EdgeInsets.only(
              right: 5.w, left: 5.w, bottom: 4.w, top: 3.w),
          child: Container(
    ...
    title: "Phone Number",
    value: "${controller.profile.value.phoneNumber}",// "+963-987654321",
    ...
    FieldContainerProfile(
    title: "E-mail",
    value:  "${controller.profile.value.email}",//"serviceprovider@gmaill.com",
    colorContainer: AppColors.greyfield.withAlpha(30),
    ),
    SizedBox(
    height: 15,
    ...
    FieldContainerProfile(
    title: "Address",
    value:  "${controller.profile.value.address}",//"Damascus,syria",
    colorContainer: AppColors.greyfield.withAlpha(30),
    ),
    SizedBox(
    height: 15,
