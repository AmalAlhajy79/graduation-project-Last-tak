...
class StoreeUserProfileScreen extends GetView<StoreProfileUserController> {
  const StoreeUserProfileScreen({Key? key}) : super(key: key);

  static const name = '/storeUserProfile';
  static final page = GetPage(
      name: name,
      page: () => const StoreeUserProfileScreen(),
      binding: StoreProfileUserBinding()
  );
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AppSubmitButton(
                      onTap: controller.storProfCustom,
                    ),
                    SizedBox(
                      height: 5.w,
                    ),
