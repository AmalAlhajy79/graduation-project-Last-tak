...
import '../../../../bank/provider-bank/provider-deposit/presentation/components/app_text_form_feild.dart';
import '../controller/update-provider-profile/update-Profile-provider-binding.dart';
import '../controller/update-provider-profile/update-Profile-provider-controller.dart';


class Update_ProviderProfileScreen extends GetView<Update_ProfileProviderController> {
  const Update_ProviderProfileScreen({Key? key}) : super(key: key);

  static const name = '/update_ProviderProfileScreen';
  static final page = GetPage(
      name: name,
      page: () => const Update_ProviderProfileScreen(),
      binding: Update_ProfileProviderBinding()
  );
