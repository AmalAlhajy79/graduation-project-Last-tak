...
import '../controller/transferFunds-User-bank-account/transferFunds-User-binding.dart';
import '../controller/transferFunds-User-bank-account/transferFunds-User-controller.dart';


class TransferFundsUserScreen extends GetView<TransferFundsUserController> {
  const TransferFundsUserScreen({Key? key}) : super(key: key);

  static const name = '/transferFundsUserScreen';
  static final page = GetPage(
      name: name,
      page: () => const TransferFundsUserScreen(),
      binding: TransferFundsUserBinding()
  );
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "To transfer your money from your account \n"
                    ...
                    AppSubmitButton(
                      onTap:(){ controller.transferFundsUserBank();}  //controller.storeAccountUserBank(,'hhh','','',1),
                    ),
                    SizedBox(
                      height: 5.w,
                    ),
